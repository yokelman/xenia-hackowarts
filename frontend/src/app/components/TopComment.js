  ...
  return (
    ...
    {props.data == null?<Loader />:
      ...
      <div className="flex flex-col pl-4">
        ...
        <div
          dangerouslySetInnerHTML={{ __html: marked(props.data.comment) }}
        />

      <div className="mt-5 flex items-center justify-between"><div className="flex gap-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="size-6">
